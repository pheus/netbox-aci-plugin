...
"""Layout composition tests for the fabric domain's detail views.
...
from ....views.fabric.fabrics import ACIFabricView
...
EXPECTED_LAYOUTS = {
    ...
    ACINodeInterfaceView: (
        ["ACINodeInterfacePanel", "CustomFieldsPanel", "PluginContentPanel"],
        [
    ...
    ACIVPCProtectionGroupView: (
        ["ACIVPCProtectionGroupPanel", "CustomFieldsPanel", "PluginContentPanel"],
        ["TagsPanel", "CommentsPanel", "PluginContentPanel"],
        ["PluginContentPanel"],
        1,
    ),
...
class FabricLayoutCompositionTestCase(SimpleTestCase):
    """Pin the panel composition of every fabric domain detail view."""
    ...
    def test_every_layout_view_is_pinned(self) -> None:
        ...
        self.assertCountEqual(
            EXPECTED_LAYOUTS.keys(), layout_views("netbox_aci_plugin.views.fabric")
        )
